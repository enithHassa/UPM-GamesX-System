...
<head>
<meta charset="UTF-8">
<title>GamesX : Update Profile</title>
             ...
             <div class="mainContainer">
                <table>
                    ...
                    <tr>
                        <td>Name</td>
                        <td>:</td>
                        <td><input type="text" placeholder="Name..." name="uname" value="<%= name %>"/></td>
                    </tr>
                    <tr>
                        <td>Birthday</td>
                        <td>:</td>
                        <td><input type="date" placeholder="Birthday..." name="ubirthdate" id="date" value="<%= birthdate %>"/></td>
                    </tr>
                    <tr>
                        <td>E-mail</td>
                        <td>:</td>
                        <td><input type="text" placeholder="E-mail..." name="uemail" value="<%= email %>"/></td>
                    </tr>
                    <tr>
                        <td>Phone No</td>
                        <td>:</td>
                        <td><input type="text" placeholder="Phone Number..." name="uphone" value="<%= phone %>"/></td>
                    </tr>
                    <tr>
                        <td>Address</td>
                        <td>:</td>
                        <td><input type="text" placeholder="Address..." name="uaddress" value="<%= address %>"/></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td>:</td>
                        <td><input type="password" placeholder="" name="upass" value="<%= password %>"/></td>
                    </tr>
                </table>
